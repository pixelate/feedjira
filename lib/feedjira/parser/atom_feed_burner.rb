  ...
  module Parser
    ...
    class AtomFeedBurner
      ...
      element :link, as: :url_text_html, value: :href,
                     with: { type: "text/html".freeze }
      element :link, as: :url_notype, value: :href, with: { type: nil }
      element :link, as: :feed_url_link, value: :href, with: { type: "application/atom+xml".freeze } # rubocop:disable Metrics/LineLength
      element :"atom10:link", as: :feed_url_atom10_link, value: :href,
                              with: { type: "application/atom+xml".freeze }
      elements :"atom10:link", as: :hubs, value: :href, with: { rel: "hub".freeze }
